...
# Suppose In future if the wheels changes to 5, then to make the changes in all object at one we use class/static variable which is shared among all objects.
